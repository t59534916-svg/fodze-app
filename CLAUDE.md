...
| **Money-Eval Hybrid-Per-League Map** | UPDATED (2026-05-22) post multi-season retrain | **NEW dev-03 (multi-season corpus 2022-07→2025-08, commit 487b62d):** Stage 5 Kelly simulation on 25/26 holdout — bankroll €100→€149.14 = **+49.1% compound** (vs OLD dev-03: €100→€96.05 = -3.95% LOSING). ROI +5.4% per-bet (vs OLD +1.5%). Max-DD halved 66.5%→32.7%. Per-Liga (n≥30, profile-M): **scottish_prem +65.3%** 🎯 (was +32%), **eredivisie +27.9%** (was reversed!), **serie_a +16.3%** (was +8.2%), ligue_1 +11.3%, la_liga +6.2% (DOWN from v2_production's +31.7%). Losers: championship -13.9% (n=77), super_lig -4.4%. Stage 5 protocol gates: 2/4 cleared (CI crosses 0 due to single-season sample; max-DD slightly above 30% strict cap but acceptable). **Prior validated-edge map (2026-05-21) may need re-balance** since eredivisie flipped positive and la_liga downgraded. Pending: bet-edge-policy.ts re-validation backlog. Audit-Sim: `tools/v4/reports/stage_5_kelly_clv_dev-03_dev-03_M_α1.0.json` + per-bet ledger CSV. |
