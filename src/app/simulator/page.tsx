...
// TODO: Migrate to shared styles from src/styles/components.ts
const S = {
  ...
  input: { background: "#0d0705", border: "1px solid #c4a26530", borderRadius: 6, padding: "8px 10px", color: "#ede4d4", fontSize: 13, width: "100%" } as React.CSSProperties,
};
