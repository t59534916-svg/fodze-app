...
export const TEAM_COLORS: Record<string, [string, string]> = {
  ...
  // Championship (teams not already in EPL section above)
  "Sheffield United": ["#ee2737", "#fff"],
  "Norwich City": ["#00a650", "#ffd700"], "Norwich": ["#00a650", "#ffd700"],
  "West Bromwich Albion": ["#122f67", "#fff"], "West Brom": ["#122f67", "#fff"],
  "Coventry City": ["#4aafe1", "#fff"], "Coventry": ["#4aafe1", "#fff"],
  "Middlesbrough": ["#e4002b", "#fff"],
  "Bristol City": ["#e4002b", "#fff"],
  "Watford": ["#fbee23", "#000"],
  ...
  "Birmingham City": ["#0000cc", "#fff"], "Birmingham": ["#0000cc", "#fff"],
  "Wrexham": ["#e4002b", "#fff"],
  "Charlton Athletic": ["#e4002b", "#fff"], "Charlton": ["#e4002b", "#fff"],
  "Ipswich Town": ["#003da5", "#fff"], "Ipswich": ["#003da5", "#fff"],
